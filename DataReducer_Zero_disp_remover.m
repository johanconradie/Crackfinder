function [ reduced_data ] = DataReducer( original_DIC_data, x1,x2,y1,y2 )
...
x=original_DIC_data(:,1);
y=original_DIC_data(:,2);
u_x=original_DIC_data(:,3);
u_y=original_DIC_data(:,4);
